...
| `effort`          | float | Effort estimation from LLM analysis. _See [prompt](./lib/agents/prompts/summarize.md)_. <br>**Note:** This estimation can be improved with a dedicated prompt but for now it seems to be enough for a decent issue ranking |
